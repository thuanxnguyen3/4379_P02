...
public class CameraMoveController : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        player = FindObjectOfType<PlayerMoveController>();  // Find player
    ...
    void FixedUpdate()
    {
        if (player.currentState == PlayerMoveController.State.NORMAL)
        {
    ...
    void LateUpdate()
    {
        ...
        {
            case PlayerMoveController.State.WAIT:
                SpiralProcedure();
                break;
            case PlayerMoveController.State.NORMAL:
                // Follow the player
                FollowTarget();
                break;
            case PlayerMoveController.State.DEAD:
    ...
    void StartStage()
    {
        player.currentState = PlayerMoveController.State.NORMAL;
    }
    ...
    void CameraTilt()
    {
        ...
        float scaledHorizontalTilt = Input.acceleration.x * maxHorizontalAngle;
